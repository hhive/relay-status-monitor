...
import { putGroupAlertSetting, type GroupAlertSettingsRepository } from '@/lib/group-alert-settings-handler';
...
export async function PUT(request: Request, context: Context) {
  ...
  return putGroupAlertSetting(request, (await context.params).groupId, repository);
}
